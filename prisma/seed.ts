...
const models: { brand: string; category: string; name: string; aliases?: string[]; sku?: string }[] = [
  // Nike — обувь
  { brand: 'Nike', category: 'footwear', name: 'Air Force 1', aliases: ['af1', 'аф1', 'форсы', 'аир форс'] },
  { brand: 'Nike', category: 'footwear', name: 'Dunk Low', aliases: ['данк лоу', 'данк'] },
  { brand: 'Nike', category: 'footwear', name: 'Dunk High', aliases: ['данк хай'] },
  { brand: 'Nike', category: 'footwear', name: 'Air Max 90', aliases: ['аир макс 90'] },
  { brand: 'Nike', category: 'footwear', name: 'Air Max 95' },
  { brand: 'Nike', category: 'footwear', name: 'Air Max 97' },
  ...
  { brand: 'Jordan', category: 'footwear', name: 'Air Jordan 1 High', aliases: ['aj1 high', 'дж1 хай'] },
  { brand: 'Jordan', category: 'footwear', name: 'Air Jordan 3', aliases: ['дж3'] },
  { brand: 'Jordan', category: 'footwear', name: 'Air Jordan 4', aliases: ['дж4', 'aj4'] },
  { brand: 'Jordan', category: 'footwear', name: 'Air Jordan 5', aliases: ['дж5'] },
  { brand: 'Jordan', category: 'footwear', name: 'Air Jordan 11', aliases: ['дж11'] },
  // adidas — обувь
  { brand: 'adidas', category: 'footwear', name: 'Samba', aliases: ['самба'] },
  { brand: 'adidas', category: 'footwear', name: 'Gazelle', aliases: ['газель'] },
  { brand: 'adidas', category: 'footwear', name: 'Campus 00s', aliases: ['кампус'] },
  { brand: 'adidas', category: 'footwear', name: 'Superstar', aliases: ['суперстар'] },
  { brand: 'adidas', category: 'footwear', name: 'Stan Smith', aliases: ['стэн смит'] },
  { brand: 'adidas', category: 'footwear', name: 'Forum Low', aliases: ['форум'] },
  // Yeezy — обувь
  { brand: 'Yeezy', category: 'footwear', name: 'Boost 350 V2', aliases: ['350', 'изи 350'] },
  { brand: 'Yeezy', category: 'footwear', name: 'Boost 700', aliases: ['700', 'изи 700'] },
  ...
  // New Balance — обувь
  { brand: 'New Balance', category: 'footwear', name: '2002R', aliases: ['2002', 'm2002r'] },
  { brand: 'New Balance', category: 'footwear', name: '1906R', aliases: ['1906', 'm1906r'] },
  { brand: 'New Balance', category: 'footwear', name: '1906D', aliases: ['m1906d'] },
  ...
  { brand: 'New Balance', category: 'footwear', name: '550' },
  ...
  { brand: 'Vans', category: 'footwear', name: 'Old Skool', aliases: ['олд скул'] },
  { brand: 'Vans', category: 'footwear', name: 'Knu Skool', aliases: ['кню скул'] },
  { brand: 'Converse', category: 'footwear', name: 'Chuck 70', aliases: ['чак 70'] },
  // UGG / Crocs — обувь
  { brand: 'UGG', category: 'footwear', name: 'Tazz', aliases: ['тазз'] },
  { brand: 'UGG', category: 'footwear', name: 'Classic Mini', aliases: ['классик мини'] },
  { brand: 'Crocs', category: 'footwear', name: 'Classic Clog', aliases: ['классик'] },
  ...
  { brand: 'Audemars Piguet', category: 'watches', name: 'Royal Oak', aliases: ['роял оук'] },
  { brand: 'Rolex', category: 'watches', name: 'Submariner', aliases: ['сабмаринер'] },
  { brand: 'Rolex', category: 'watches', name: 'Daytona', aliases: ['дайтона'] },
  { brand: 'Casio', category: 'watches', name: 'G-Shock', aliases: ['джишок', 'gshock'] },
  // Аксессуары — сумки
